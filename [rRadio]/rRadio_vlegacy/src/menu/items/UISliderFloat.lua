...
local SettingsSlider = {
    ...
    LeftArrow = { Dictionary = "commonmenu", Texture = "arrowleft", X = 235, Y = 12, Width = 15.5, Height = 15 },
    RightArrow = { Dictionary = "commonmenu", Texture = "arrowright", X = 400, Y = 12, Width = 15.5, Height = 15 },
}
...
function RageUI.UISliderFloat(Label, ItemIndex, Description, Style, Actions, Value)
